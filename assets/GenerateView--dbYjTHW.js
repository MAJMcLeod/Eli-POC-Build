...
const result = await generator.generate({
  ...
  guidanceScale: 7.5
});`}]},{id:"landscapes",title:"Landscapes",content:[{type:"paragraph",text:"Landscapes are one of the most popular subjects for AI image generation. They can range from realistic nature scenes to fantastical environments."},{type:"image",src:"/Eli-POC-Build/assets/mock/general/jalaison_A_serene_minimalist_photograph_of_a_lighthouse_on_the__b723de58-954e-40b1-9b58-9d12aaa2cc58.png",alt:"Minimalist lighthouse landscape",caption:"A serene minimalist photograph of a lighthouse on the coast"},{type:"paragraph",text:"When generating landscapes, consider including details about:"},{type:"list",items:["Time of day (sunrise, sunset, night, etc.)","Weather conditions (clear, cloudy, rainy, snowy)","Geographical features (mountains, forests, oceans, deserts)","Lighting and atmosphere (foggy, misty, golden hour)"]},{type:"image",src:"/Eli-POC-Build/assets/mock/general/meshadventures_A_dramatic_view_of_the_Empire_State_Building_fro_8e20eb61-7df8-43b5-80bb-7ad75f47f3f6.png",alt:"Urban landscape",caption:"A dramatic view of the Empire State Building - urban landscapes can be just as compelling as natural ones"},{type:"code",language:"javascript",text:`// Landscape generation example
const result = await generator.generate({
