import{_ as $,H as v,k as p,o as d,a as o,w as c,h as f,i as S,a4 as Xe,v as pe,a5 as De,a6 as Se,A as Q,E as ke,x as w,a7 as Qe,R as Ze,P as et,a8 as Ie,a9 as ge,aa as tt,s as ve,ab as at,ac as Fe,C as ot,ad as st,ae as it,L as ye,M as se,a2 as fe,af as qe,ag as nt,a3 as rt,S as Ee,D as lt,z as $e,ah as Me,ai as Le,aj as _e,ak as he,al as ze,am as dt,F as L,an as ct,f as t,Z as ie,ao as ut,K as mt,ap as pt,aq as me,ar as gt,as as ht,at as ft,au as _t,av as vt,aw as yt,ax as bt,ay as wt,az as kt,t as m,g as G,n as Y,aA as Pe,p as Be,l as J,c as q,aB as xt,aC as At,aD as be,aE as St,aF as It,aG as de,m as xe,aH as Pt}from"./index-CjBl4Rls.js";import{V as Ct,a as ue}from"./VTabs-DmgK2bZa.js";import{V as Rt}from"./VSelect-B0c11ewD.js";import{V as Dt}from"./VChip-BteXtRWr.js";const $t={class:"media-generate-nav-slider"},Vt={__name:"MediaGenerateNavSlider",props:{modelValue:{type:String,default:"run"}},emits:["update:modelValue","tabChange"],setup(e,{emit:s}){const a=e,i=s,r=v({get:()=>a.modelValue,set:l=>{i("update:modelValue",l)}});return(l,n)=>(d(),p("div",$t,[o(Xe,{flat:"",class:"pa-0"},{default:c(()=>[o(Ct,{modelValue:r.value,"onUpdate:modelValue":n[0]||(n[0]=u=>r.value=u),color:"primary","align-tabs":"start","show-arrows":"","slider-color":"primary",height:"48"},{default:c(()=>[o(ue,{value:"run",class:"text-none"},{default:c(()=>[o(S,{start:""},{default:c(()=>n[1]||(n[1]=[f("mdi-play-outline")])),_:1}),n[2]||(n[2]=f(" Run "))]),_:1}),o(ue,{value:"examples",class:"text-none"},{default:c(()=>[o(S,{start:""},{default:c(()=>n[3]||(n[3]=[f("mdi-book-open-outline")])),_:1}),n[4]||(n[4]=f(" Examples "))]),_:1}),o(ue,{value:"docs",class:"text-none"},{default:c(()=>[o(S,{start:""},{default:c(()=>n[5]||(n[5]=[f("mdi-file-document-outline")])),_:1}),n[6]||(n[6]=f(" Docs "))]),_:1}),o(ue,{value:"forums",class:"text-none"},{default:c(()=>[o(S,{start:""},{default:c(()=>n[7]||(n[7]=[f("mdi-forum-outline")])),_:1}),n[8]||(n[8]=f(" Forums "))]),_:1}),o(ue,{value:"history",class:"text-none"},{default:c(()=>[o(S,{start:""},{default:c(()=>n[9]||(n[9]=[f("mdi-history")])),_:1}),n[10]||(n[10]=f(" History "))]),_:1}),o(ue,{value:"api",class:"text-none"},{default:c(()=>[o(S,{start:""},{default:c(()=>n[11]||(n[11]=[f("mdi-code-json")])),_:1}),n[12]||(n[12]=f(" API "))]),_:1})]),_:1},8,["modelValue"])]),_:1})]))}},Tt=$(Vt,[["__scopeId","data-v-6c6da649"]]),Ce=Symbol.for("vuetify:v-slider");function Ut(e,s,a){const i=a==="vertical",r=s.getBoundingClientRect(),l="touches"in e?e.touches[0]:e;return i?l.clientY-(r.top+r.height/2):l.clientX-(r.left+r.width/2)}function Ft(e,s){return"touches"in e&&e.touches.length?e.touches[0][s]:"changedTouches"in e&&e.changedTouches.length?e.changedTouches[0][s]:e[s]}const qt=pe({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>typeof e=="boolean"||e==="always"},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>typeof e=="boolean"||e==="always"},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...et(),...Ze({elevation:2}),ripple:{type:Boolean,default:!0}},"Slider"),Et=e=>{const s=v(()=>parseFloat(e.min)),a=v(()=>parseFloat(e.max)),i=v(()=>Number(e.step)>0?parseFloat(e.step):0),r=v(()=>Math.max(De(i.value),De(s.value)));function l(n){if(n=parseFloat(n),i.value<=0)return n;const u=Ie(n,s.value,a.value),y=s.value%i.value,E=Math.round((u-y)/i.value)*i.value+y;return parseFloat(Math.min(E,a.value).toFixed(r.value))}return{min:s,max:a,step:i,decimals:r,roundValue:l}},Mt=e=>{let{props:s,steps:a,onSliderStart:i,onSliderMove:r,onSliderEnd:l,getActiveThumb:n}=e;const{isRtl:u}=Se(),y=Q(s,"reverse"),E=v(()=>s.direction==="vertical"),B=v(()=>E.value!==y.value),{min:g,max:A,step:M,decimals:K,roundValue:z}=a,Z=v(()=>parseInt(s.thumbSize,10)),N=v(()=>parseInt(s.tickSize,10)),O=v(()=>parseInt(s.trackSize,10)),W=v(()=>(A.value-g.value)/M.value),ee=Q(s,"disabled"),H=v(()=>s.error||s.disabled?void 0:s.thumbColor??s.color),x=v(()=>s.error||s.disabled?void 0:s.trackColor??s.color),F=v(()=>s.error||s.disabled?void 0:s.trackFillColor??s.color),D=ke(!1),I=ke(0),C=w(),_=w();function b(h){var Re;const k=(Re=C.value)==null?void 0:Re.$el;if(!k)return;const le=s.direction==="vertical",We=le?"top":"left",He=le?"height":"width",Ke=le?"clientY":"clientX",{[We]:Oe,[He]:Ye}=k.getBoundingClientRect(),Je=Ft(h,Ke);let we=Math.min(Math.max((Je-Oe-I.value)/Ye,0),1)||0;return(le?B.value:B.value!==u.value)&&(we=1-we),z(g.value+we*(A.value-g.value))}const P=h=>{const k=b(h);k!=null&&l({value:k}),D.value=!1,I.value=0},V=h=>{const k=b(h);_.value=n(h),_.value&&(D.value=!0,_.value.contains(h.target)?I.value=Ut(h,_.value,s.direction):(I.value=0,k!=null&&r({value:k})),k!=null&&i({value:k}),ge(()=>{var le;return(le=_.value)==null?void 0:le.focus()}))},T={passive:!0,capture:!0};function X(h){const k=b(h);k!=null&&r({value:k})}function te(h){h.stopPropagation(),h.preventDefault(),P(h),window.removeEventListener("mousemove",X,T),window.removeEventListener("mouseup",te)}function j(h){var k;P(h),window.removeEventListener("touchmove",X,T),(k=h.target)==null||k.removeEventListener("touchend",j)}function ae(h){var k;V(h),window.addEventListener("touchmove",X,T),(k=h.target)==null||k.addEventListener("touchend",j,{passive:!1})}function U(h){h.button===0&&(h.preventDefault(),V(h),window.addEventListener("mousemove",X,T),window.addEventListener("mouseup",te,{passive:!1}))}const R=h=>{const k=(h-g.value)/(A.value-g.value)*100;return Ie(isNaN(k)?0:k,0,100)},oe=Q(s,"showTicks"),ne=v(()=>oe.value?s.ticks?Array.isArray(s.ticks)?s.ticks.map(h=>({value:h,position:R(h),label:h.toString()})):Object.keys(s.ticks).map(h=>({value:parseFloat(h),position:R(parseFloat(h)),label:s.ticks[h]})):W.value!==1/0?Qe(W.value+1).map(h=>{const k=g.value+h*M.value;return{value:k,position:R(k)}}):[]:[]),ce=v(()=>ne.value.some(h=>{let{label:k}=h;return!!k})),re={activeThumbRef:_,color:Q(s,"color"),decimals:K,disabled:ee,direction:Q(s,"direction"),elevation:Q(s,"elevation"),hasLabels:ce,isReversed:y,indexFromEnd:B,min:g,max:A,mousePressed:D,numTicks:W,onSliderMousedown:U,onSliderTouchstart:ae,parsedTicks:ne,parseMouseMove:b,position:R,readonly:Q(s,"readonly"),rounded:Q(s,"rounded"),roundValue:z,showTicks:oe,startOffset:I,step:M,thumbSize:Z,thumbColor:H,thumbLabel:Q(s,"thumbLabel"),ticks:Q(s,"ticks"),tickSize:N,trackColor:x,trackContainerRef:C,trackFillColor:F,trackSize:O,vertical:E};return tt(Ce,re),re},Lt=pe({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,...Ee()},"VSliderThumb"),zt=ve()({name:"VSliderThumb",directives:{Ripple:at},props:Lt(),emits:{"update:modelValue":e=>!0},setup(e,s){let{slots:a,emit:i}=s;const r=Fe(Ce),{isRtl:l,rtlClasses:n}=Se();if(!r)throw new Error("[Vuetify] v-slider-thumb must be used inside v-slider or v-range-slider");const{thumbColor:u,step:y,disabled:E,thumbSize:B,thumbLabel:g,direction:A,isReversed:M,vertical:K,readonly:z,elevation:Z,mousePressed:N,decimals:O,indexFromEnd:W}=r,ee=v(()=>E.value?void 0:Z.value),{elevationClasses:H}=ot(ee),{textColorClasses:x,textColorStyles:F}=st(u),{pageup:D,pagedown:I,end:C,home:_,left:b,right:P,down:V,up:T}=it,X=[D,I,C,_,b,P,V,T],te=v(()=>y.value?[1,2,3]:[1,5,10]);function j(U,R){if(!X.includes(U.key))return;U.preventDefault();const oe=y.value||.1,ne=(e.max-e.min)/oe;if([b,P,V,T].includes(U.key)){const re=(K.value?[l.value?b:P,M.value?V:T]:W.value!==l.value?[b,T]:[P,T]).includes(U.key)?1:-1,h=U.shiftKey?2:U.ctrlKey?1:0;R=R+re*oe*te.value[h]}else if(U.key===_)R=e.min;else if(U.key===C)R=e.max;else{const ce=U.key===I?1:-1;R=R-ce*oe*(ne>100?ne/10:10)}return Math.max(e.min,Math.min(e.max,R))}function ae(U){const R=j(U,e.modelValue);R!=null&&i("update:modelValue",R)}return ye(()=>{const U=se(W.value?100-e.position:e.position,"%");return o("div",{class:["v-slider-thumb",{"v-slider-thumb--focused":e.focused,"v-slider-thumb--pressed":e.focused&&N.value},e.class,n.value],style:[{"--v-slider-thumb-position":U,"--v-slider-thumb-size":se(B.value)},e.style],role:"slider",tabindex:E.value?-1:0,"aria-label":e.name,"aria-valuemin":e.min,"aria-valuemax":e.max,"aria-valuenow":e.modelValue,"aria-readonly":!!z.value,"aria-orientation":A.value,onKeydown:z.value?void 0:ae},[o("div",{class:["v-slider-thumb__surface",x.value,H.value],style:{...F.value}},null),fe(o("div",{class:["v-slider-thumb__ripple",x.value],style:F.value},null),[[qe("ripple"),e.ripple,null,{circle:!0,center:!0}]]),o(nt,{origin:"bottom center"},{default:()=>{var R;return[fe(o("div",{class:"v-slider-thumb__label-container"},[o("div",{class:["v-slider-thumb__label"]},[o("div",null,[((R=a["thumb-label"])==null?void 0:R.call(a,{modelValue:e.modelValue}))??e.modelValue.toFixed(y.value?O.value:1)])])]),[[rt,g.value&&e.focused||g.value==="always"]])]}})])}),{}}}),Bt=pe({start:{type:Number,required:!0},stop:{type:Number,required:!0},...Ee()},"VSliderTrack"),jt=ve()({name:"VSliderTrack",props:Bt(),emits:{},setup(e,s){let{slots:a}=s;const i=Fe(Ce);if(!i)throw new Error("[Vuetify] v-slider-track must be inside v-slider or v-range-slider");const{color:r,parsedTicks:l,rounded:n,showTicks:u,tickSize:y,trackColor:E,trackFillColor:B,trackSize:g,vertical:A,min:M,max:K,indexFromEnd:z}=i,{roundedClasses:Z}=lt(n),{backgroundColorClasses:N,backgroundColorStyles:O}=$e(B),{backgroundColorClasses:W,backgroundColorStyles:ee}=$e(E),H=v(()=>`inset-${A.value?"block":"inline"}-${z.value?"end":"start"}`),x=v(()=>A.value?"height":"width"),F=v(()=>({[H.value]:"0%",[x.value]:"100%"})),D=v(()=>e.stop-e.start),I=v(()=>({[H.value]:se(e.start,"%"),[x.value]:se(D.value,"%")})),C=v(()=>u.value?(A.value?l.value.slice().reverse():l.value).map((b,P)=>{var T;const V=b.value!==M.value&&b.value!==K.value?se(b.position,"%"):void 0;return o("div",{key:b.value,class:["v-slider-track__tick",{"v-slider-track__tick--filled":b.position>=e.start&&b.position<=e.stop,"v-slider-track__tick--first":b.value===M.value,"v-slider-track__tick--last":b.value===K.value}],style:{[H.value]:V}},[(b.label||a["tick-label"])&&o("div",{class:"v-slider-track__tick-label"},[((T=a["tick-label"])==null?void 0:T.call(a,{tick:b,index:P}))??b.label])])}):[]);return ye(()=>o("div",{class:["v-slider-track",Z.value,e.class],style:[{"--v-slider-track-size":se(g.value),"--v-slider-tick-size":se(y.value)},e.style]},[o("div",{class:["v-slider-track__background",W.value,{"v-slider-track__background--opacity":!!r.value||!B.value}],style:{...F.value,...ee.value}},null),o("div",{class:["v-slider-track__fill",N.value],style:{...I.value,...O.value}},null),u.value&&o("div",{class:["v-slider-track__ticks",{"v-slider-track__ticks--always-show":u.value==="always"}]},[C.value])])),{}}}),Gt=pe({...dt(),...qt(),...ze(),modelValue:{type:[Number,String],default:0}},"VSlider"),Ve=ve()({name:"VSlider",props:Gt(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,start:e=>!0,end:e=>!0},setup(e,s){let{slots:a,emit:i}=s;const r=w(),{rtlClasses:l}=Se(),n=Et(e),u=Me(e,"modelValue",void 0,x=>n.roundValue(x??n.min.value)),{min:y,max:E,mousePressed:B,roundValue:g,onSliderMousedown:A,onSliderTouchstart:M,trackContainerRef:K,position:z,hasLabels:Z,readonly:N}=Mt({props:e,steps:n,onSliderStart:()=>{i("start",u.value)},onSliderEnd:x=>{let{value:F}=x;const D=g(F);u.value=D,i("end",D)},onSliderMove:x=>{let{value:F}=x;return u.value=g(F)},getActiveThumb:()=>{var x;return(x=r.value)==null?void 0:x.$el}}),{isFocused:O,focus:W,blur:ee}=Le(e),H=v(()=>z(u.value));return ye(()=>{const x=_e.filterProps(e),F=!!(e.label||a.label||a.prepend);return o(_e,he({class:["v-slider",{"v-slider--has-labels":!!a["tick-label"]||Z.value,"v-slider--focused":O.value,"v-slider--pressed":B.value,"v-slider--disabled":e.disabled},l.value,e.class],style:e.style},x,{focused:O.value}),{...a,prepend:F?D=>{var I,C;return o(L,null,[((I=a.label)==null?void 0:I.call(a,D))??(e.label?o(ct,{id:D.id.value,class:"v-slider__label",text:e.label},null):void 0),(C=a.prepend)==null?void 0:C.call(a,D)])}:void 0,default:D=>{let{id:I,messagesId:C}=D;return o("div",{class:"v-slider__container",onMousedown:N.value?void 0:A,onTouchstartPassive:N.value?void 0:M},[o("input",{id:I.value,name:e.name||I.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:u.value},null),o(jt,{ref:K,start:0,stop:H.value},{"tick-label":a["tick-label"]}),o(zt,{ref:r,"aria-describedby":C.value,focused:O.value,min:y.value,max:E.value,modelValue:u.value,"onUpdate:modelValue":_=>u.value=_,position:H.value,elevation:e.elevation,onFocus:W,onBlur:ee,ripple:e.ripple,name:e.name},{"thumb-label":a["thumb-label"]})])}})}),{}}}),Nt={class:"run-advanced-settings"},Wt={class:"setting-field"},Ht={class:"setting-field"},Kt={class:"setting-field"},Ot={class:"setting-field"},Yt={__name:"RunAdvancedSettings",setup(e){const s=w(-1),a=w(7.5),i=w(30),r=w("DPM++ 2M Karras"),l=["DPM++ 2M Karras","Euler a","DPM++ SDE Karras","DPM++ 2M SDE Karras","DDIM"];return(n,u)=>(d(),p("div",Nt,[t("div",Wt,[u[6]||(u[6]=t("div",{class:"field-label"},"seed",-1)),o(ie,{modelValue:s.value,"onUpdate:modelValue":u[0]||(u[0]=y=>s.value=y),variant:"outlined","hide-details":"",type:"number",density:"compact","bg-color":"rgba(42, 42, 42, 0.8)",placeholder:"-1 for random"},null,8,["modelValue"])]),t("div",Ht,[u[7]||(u[7]=t("div",{class:"field-label"},"guidance_scale",-1)),o(Ve,{modelValue:a.value,"onUpdate:modelValue":u[2]||(u[2]=y=>a.value=y),min:"1",max:"20",step:"0.1","thumb-label":"","hide-details":"",color:"primary"},{append:c(()=>[o(ie,{modelValue:a.value,"onUpdate:modelValue":u[1]||(u[1]=y=>a.value=y),type:"number",style:{width:"70px"},density:"compact","hide-details":"",variant:"outlined","bg-color":"rgba(42, 42, 42, 0.8)"},null,8,["modelValue"])]),_:1},8,["modelValue"])]),t("div",Kt,[u[8]||(u[8]=t("div",{class:"field-label"},"steps",-1)),o(Ve,{modelValue:i.value,"onUpdate:modelValue":u[4]||(u[4]=y=>i.value=y),min:"10",max:"100",step:"1","thumb-label":"","hide-details":"",color:"primary"},{append:c(()=>[o(ie,{modelValue:i.value,"onUpdate:modelValue":u[3]||(u[3]=y=>i.value=y),type:"number",style:{width:"70px"},density:"compact","hide-details":"",variant:"outlined","bg-color":"rgba(42, 42, 42, 0.8)"},null,8,["modelValue"])]),_:1},8,["modelValue"])]),t("div",Ot,[u[9]||(u[9]=t("div",{class:"field-label"},"sampler",-1)),o(Rt,{modelValue:r.value,"onUpdate:modelValue":u[5]||(u[5]=y=>r.value=y),items:l,variant:"outlined","hide-details":"",density:"compact","bg-color":"rgba(42, 42, 42, 0.8)"},null,8,["modelValue"])])]))}},Jt=$(Yt,[["__scopeId","data-v-e22daca1"]]),Xt=pe({autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...ze(),...vt()},"VTextarea"),Te=ve()({name:"VTextarea",directives:{Intersect:ut},inheritAttrs:!1,props:Xt(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,s){let{attrs:a,emit:i,slots:r}=s;const l=Me(e,"modelValue"),{isFocused:n,focus:u,blur:y}=Le(e),E=v(()=>typeof e.counterValue=="function"?e.counterValue(l.value):(l.value||"").toString().length),B=v(()=>{if(a.maxlength)return a.maxlength;if(!(!e.counter||typeof e.counter!="number"&&typeof e.counter!="string"))return e.counter});function g(_,b){var P,V;!e.autofocus||!_||(V=(P=b[0].target)==null?void 0:P.focus)==null||V.call(P)}const A=w(),M=w(),K=ke(""),z=w(),Z=v(()=>e.persistentPlaceholder||n.value||e.active);function N(){var _;z.value!==document.activeElement&&((_=z.value)==null||_.focus()),n.value||u()}function O(_){N(),i("click:control",_)}function W(_){i("mousedown:control",_)}function ee(_){_.stopPropagation(),N(),ge(()=>{l.value="",kt(e["onClick:clear"],_)})}function H(_){var P;const b=_.target;if(l.value=b.value,(P=e.modelModifiers)!=null&&P.trim){const V=[b.selectionStart,b.selectionEnd];ge(()=>{b.selectionStart=V[0],b.selectionEnd=V[1]})}}const x=w(),F=w(Number(e.rows)),D=v(()=>["plain","underlined"].includes(e.variant));mt(()=>{e.autoGrow||(F.value=Number(e.rows))});function I(){e.autoGrow&&ge(()=>{if(!x.value||!M.value)return;const _=getComputedStyle(x.value),b=getComputedStyle(M.value.$el),P=parseFloat(_.getPropertyValue("--v-field-padding-top"))+parseFloat(_.getPropertyValue("--v-input-padding-top"))+parseFloat(_.getPropertyValue("--v-field-padding-bottom")),V=x.value.scrollHeight,T=parseFloat(_.lineHeight),X=Math.max(parseFloat(e.rows)*T+P,parseFloat(b.getPropertyValue("--v-input-control-height"))),te=parseFloat(e.maxRows)*T+P||1/0,j=Ie(V??0,X,te);F.value=Math.floor((j-P)/T),K.value=se(j)})}pt(I),me(l,I),me(()=>e.rows,I),me(()=>e.maxRows,I),me(()=>e.density,I);let C;return me(x,_=>{_?(C=new ResizeObserver(I),C.observe(x.value)):C==null||C.disconnect()}),gt(()=>{C==null||C.disconnect()}),ye(()=>{const _=!!(r.counter||e.counter||e.counterValue),b=!!(_||r.details),[P,V]=ht(a),{modelValue:T,...X}=_e.filterProps(e),te=ft(e);return o(_e,he({ref:A,modelValue:l.value,"onUpdate:modelValue":j=>l.value=j,class:["v-textarea v-text-field",{"v-textarea--prefixed":e.prefix,"v-textarea--suffixed":e.suffix,"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-textarea--auto-grow":e.autoGrow,"v-textarea--no-resize":e.noResize||e.autoGrow,"v-input--plain-underlined":D.value},e.class],style:e.style},P,X,{centerAffix:F.value===1&&!D.value,focused:n.value}),{...r,default:j=>{let{id:ae,isDisabled:U,isDirty:R,isReadonly:oe,isValid:ne}=j;return o(bt,he({ref:M,style:{"--v-textarea-control-height":K.value},onClick:O,onMousedown:W,"onClick:clear":ee,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},te,{id:ae.value,active:Z.value||R.value,centerAffix:F.value===1&&!D.value,dirty:R.value||e.dirty,disabled:U.value,focused:n.value,error:ne.value===!1}),{...r,default:ce=>{let{props:{class:re,...h}}=ce;return o(L,null,[e.prefix&&o("span",{class:"v-text-field__prefix"},[e.prefix]),fe(o("textarea",he({ref:z,class:re,value:l.value,onInput:H,autofocus:e.autofocus,readonly:oe.value,disabled:U.value,placeholder:e.placeholder,rows:e.rows,name:e.name,onFocus:N,onBlur:y},h,V),null),[[qe("intersect"),{handler:g},null,{once:!0}]]),e.autoGrow&&fe(o("textarea",{class:[re,"v-textarea__sizer"],id:`${h.id}-sizer`,"onUpdate:modelValue":k=>l.value=k,ref:x,readonly:!0,"aria-hidden":"true"},null),[[wt,l.value]]),e.suffix&&o("span",{class:"v-text-field__suffix"},[e.suffix])])}})},details:b?j=>{var ae;return o(L,null,[(ae=r.details)==null?void 0:ae.call(r,j),_&&o(L,null,[o("span",null,null),o(yt,{active:e.persistentCounter||n.value,value:E.value,max:B.value,disabled:e.disabled},r.counter)])])}:void 0})}),_t({},A,M,z)}}),Qt={class:"run-settings-panel"},Zt={class:"panel-header"},ea={class:"panel-content"},ta={key:0,class:"settings-fields"},aa={class:"setting-field"},oa={class:"setting-field"},sa={class:"setting-field dimensions-row"},ia={class:"dimension-field"},na={class:"dimension-field"},ra={class:"setting-field"},la={key:0,class:"advanced-settings"},da={class:"panel-footer"},ca={__name:"RunSettingsPanel",setup(e){const s=w(!1),a=w(!1),i=w("Image of a man in a park, man is wearing black smart trenchcoat and hat"),r=w("Weird hands, unrealistic, creepy"),l=w(512),n=w(512),u=w(1),y=()=>{a.value=!a.value},E=()=>{console.log("Generating image with settings:",{prompt:i.value,negativePrompt:r.value,width:l.value,height:n.value,numOutputs:u.value})};return(B,g)=>(d(),p("div",Qt,[t("div",Zt,[g[5]||(g[5]=t("div",{class:"panel-title"},"settings",-1)),o(G,{variant:"text",class:"advanced-btn",density:"compact",onClick:y},{default:c(()=>[f(m(a.value?"basic":"advanced"),1)]),_:1})]),t("div",ea,[s.value?Y("",!0):(d(),p("div",ta,[t("div",aa,[g[6]||(g[6]=t("div",{class:"field-label"},"prompt",-1)),o(Te,{modelValue:i.value,"onUpdate:modelValue":g[0]||(g[0]=A=>i.value=A),variant:"outlined","auto-grow":"",rows:"3","hide-details":"",class:"prompt-field","bg-color":"rgba(42, 42, 42, 0.8)"},null,8,["modelValue"])]),t("div",oa,[g[7]||(g[7]=t("div",{class:"field-label"},"negative_prompt",-1)),o(Te,{modelValue:r.value,"onUpdate:modelValue":g[1]||(g[1]=A=>r.value=A),variant:"outlined","auto-grow":"",rows:"3","hide-details":"",class:"negative-prompt-field","bg-color":"rgba(42, 42, 42, 0.8)"},null,8,["modelValue"])]),t("div",sa,[t("div",ia,[g[8]||(g[8]=t("div",{class:"field-label"},"width",-1)),o(ie,{modelValue:l.value,"onUpdate:modelValue":g[2]||(g[2]=A=>l.value=A),variant:"outlined","hide-details":"",type:"number",density:"compact","bg-color":"rgba(42, 42, 42, 0.8)"},null,8,["modelValue"])]),t("div",na,[g[9]||(g[9]=t("div",{class:"field-label"},"height",-1)),o(ie,{modelValue:n.value,"onUpdate:modelValue":g[3]||(g[3]=A=>n.value=A),variant:"outlined","hide-details":"",type:"number",density:"compact","bg-color":"rgba(42, 42, 42, 0.8)"},null,8,["modelValue"])])]),t("div",ra,[g[10]||(g[10]=t("div",{class:"field-label"},"num_outputs",-1)),o(ie,{modelValue:u.value,"onUpdate:modelValue":g[4]||(g[4]=A=>u.value=A),variant:"outlined","hide-details":"",type:"number",density:"compact","bg-color":"rgba(42, 42, 42, 0.8)"},null,8,["modelValue"])]),o(Pe,null,{default:c(()=>[a.value?(d(),p("div",la,[o(Jt)])):Y("",!0)]),_:1})]))]),t("div",da,[g[13]||(g[13]=t("div",{class:"spacer"},null,-1)),o(G,{variant:"outlined",color:"primary",class:"generate-btn",onClick:E,disabled:!i.value},{default:c(()=>[g[12]||(g[12]=f(" Generate ")),o(S,{end:"",class:"chevron-icon"},{default:c(()=>g[11]||(g[11]=[f("mdi-chevron-right")])),_:1})]),_:1},8,["disabled"])])]))}},ua=$(ca,[["__scopeId","data-v-c47045f7"]]),ma={class:"run-generation-item"},pa={class:"generation-header"},ga={class:"generation-title"},ha={class:"model-name"},fa={class:"timestamp"},_a={class:"generation-actions"},va={class:"action-buttons"},ya={class:"generation-image-container"},ba=["src","alt"],wa={__name:"RunGenerationItem",props:{generation:{type:Object,required:!0}},setup(e){return(s,a)=>(d(),p("div",ma,[t("div",pa,[t("div",ga,[t("span",ha,m(e.generation.model),1),a[0]||(a[0]=t("span",{class:"separator"},"-",-1)),t("span",fa,m(e.generation.timestamp),1)]),t("div",_a,[o(G,{variant:"text",density:"compact",class:"settings-btn pa-0"},{default:c(()=>[o(S,{size:"small",class:"settings-icon"},{default:c(()=>a[1]||(a[1]=[f("mdi-cog-outline")])),_:1}),a[2]||(a[2]=t("span",{class:"settings-text"},"settings",-1))]),_:1}),t("div",va,[o(G,{variant:"text",density:"compact",class:"action-btn"},{default:c(()=>[o(S,{size:"small"},{default:c(()=>a[3]||(a[3]=[f("mdi-fullscreen")])),_:1})]),_:1}),o(G,{variant:"text",density:"compact",class:"action-btn"},{default:c(()=>[o(S,{size:"small"},{default:c(()=>a[4]||(a[4]=[f("mdi-download-outline")])),_:1})]),_:1}),o(G,{variant:"text",density:"compact",class:"action-btn"},{default:c(()=>[o(S,{size:"small"},{default:c(()=>a[5]||(a[5]=[f("mdi-share-variant-outline")])),_:1})]),_:1}),o(G,{variant:"text",density:"compact",class:"action-btn"},{default:c(()=>[o(S,{size:"small"},{default:c(()=>a[6]||(a[6]=[f("mdi-delete-outline")])),_:1})]),_:1})])])]),t("div",ya,[t("img",{src:e.generation.imageUrl,alt:e.generation.model+" generation",class:"generation-image"},null,8,ba)])]))}},ka=$(wa,[["__scopeId","data-v-6f1db1ad"]]),xa={class:"run-generations-list"},Aa={class:"generations-container"},Sa={key:0,class:"no-generations"},Ia={__name:"RunGenerationsList",setup(e){const a=w(Be([{id:1,model:"sdxl-generation",timestamp:"now",imageUrl:"/assets/mock/general/ilightice_A_bright_and_colorful_photo_of_an_influencer_in_a_vib_438201a7-d193-40fa-a820-d121ec13e4bd.png"},{id:2,model:"sdxl-generation",timestamp:"09:17",imageUrl:"/assets/mock/general/jalaison_A_serene_minimalist_photograph_of_a_lighthouse_on_the__b723de58-954e-40b1-9b58-9d12aaa2cc58.png"},{id:3,model:"sdxl-generation",timestamp:"08:45",imageUrl:"/assets/mock/general/sparta.cass_Virgo_astrology_full_moon_--ar_45_--stylize_250_--v_dc3f4528-f7ed-4310-9c87-f6d204d2b653.png"}]));return(i,r)=>(d(),p("div",xa,[t("div",Aa,[(d(!0),p(L,null,J(a.value,l=>(d(),q(ka,{key:l.id,generation:l,class:"generation-item"},null,8,["generation"]))),128)),a.value.length===0?(d(),p("div",Sa,[o(S,{size:"64",color:"grey-darken-1"},{default:c(()=>r[0]||(r[0]=[f("mdi-image-outline")])),_:1}),r[1]||(r[1]=t("div",{class:"placeholder-text"},"No generations yet",-1)),r[2]||(r[2]=t("div",{class:"placeholder-subtext"},"Configure settings in the panel and click Generate",-1))])):Y("",!0)])]))}},Pa=$(Ia,[["__scopeId","data-v-3948271e"]]),Ca={class:"run-section"},Ra={class:"run-container"},Da={class:"content-area"},$a={__name:"RunSection",setup(e){return(s,a)=>(d(),p("div",Ca,[t("div",Ra,[o(ua,{class:"settings-panel"}),t("div",Da,[o(Pa)])])]))}},Ue=$($a,[["__scopeId","data-v-ad2bb909"]]),Va={class:"example-panel"},Ta={class:"input-side"},Ua={class:"input-fields"},Fa={class:"input-field"},qa={class:"field-value prompt-value"},Ea={class:"input-field"},Ma={class:"field-value negative-prompt-value"},La={class:"input-field dimensions-field"},za={class:"dimension-field"},Ba={class:"field-value"},ja={class:"dimension-field"},Ga={class:"field-value"},Na={class:"input-field"},Wa={class:"field-value"},Ha={class:"input-field"},Ka={class:"field-value"},Oa={class:"input-field"},Ya={class:"field-value"},Ja={class:"output-side"},Xa={class:"output-image-container"},Qa=["src","alt"],Za={__name:"ExamplePanel",props:{example:{type:Object,required:!0}},setup(e){return(s,a)=>(d(),p("div",Va,[t("div",Ta,[a[7]||(a[7]=t("div",{class:"panel-title"},"input",-1)),t("div",Ua,[t("div",Fa,[a[0]||(a[0]=t("div",{class:"field-label"},"prompt",-1)),t("div",qa,m(e.example.prompt),1)]),t("div",Ea,[a[1]||(a[1]=t("div",{class:"field-label"},"negative_prompt",-1)),t("div",Ma,m(e.example.negativePrompt),1)]),t("div",La,[t("div",za,[a[2]||(a[2]=t("div",{class:"field-label"},"width",-1)),t("div",Ba,m(e.example.width),1)]),t("div",ja,[a[3]||(a[3]=t("div",{class:"field-label"},"height",-1)),t("div",Ga,m(e.example.height),1)])]),t("div",Na,[a[4]||(a[4]=t("div",{class:"field-label"},"num_outputs",-1)),t("div",Wa,m(e.example.numOutputs),1)]),t("div",Ha,[a[5]||(a[5]=t("div",{class:"field-label"},"scheduler",-1)),t("div",Ka,m(e.example.scheduler),1)]),t("div",Oa,[a[6]||(a[6]=t("div",{class:"field-label"},"inference_steps",-1)),t("div",Ya,m(e.example.inferenceSteps),1)])])]),t("div",Ja,[a[8]||(a[8]=t("div",{class:"panel-title"},"output",-1)),t("div",Xa,[t("img",{src:e.example.outputImage,alt:"Example output for "+e.example.prompt,class:"output-image"},null,8,Qa)])])]))}},eo=$(Za,[["__scopeId","data-v-ad7088b7"]]),to={class:"examples-section"},ao={class:"examples-container"},oo={__name:"ExamplesSection",setup(e){const a=w(Be([{id:1,scheduler:"K_EULER",inferenceSteps:25,guidanceScale:7.5,promptStrength:.8,seed:"",prompt:"Image of a man in a park, man is wearing black smart trenchcoat and hat",negativePrompt:"Weird hands, unrealistic, creepy",width:512,height:512,numOutputs:1,outputImage:"/assets/mock/general/davidezin_Cinematic_portrait_photo_of_A_male_model_stands_with__1a662122-314e-4221-a90f-54818a0563fb (1).png"},{id:2,scheduler:"K_EULER",inferenceSteps:30,guidanceScale:8,promptStrength:.9,seed:"42",prompt:"A girl floating with balloons in a city at sunset",negativePrompt:"Blurry, bad anatomy, extra limbs, poorly drawn face",width:512,height:512,numOutputs:1,outputImage:"/assets/mock/general/yyuanlit_Future_black_technology_mountain_future_sense_black_go_38a4cd9f-c267-4f17-980a-4b43fc541d43.png"},{id:3,scheduler:"DPM++",inferenceSteps:40,guidanceScale:9,promptStrength:.85,seed:"12345",prompt:"Futuristic cityscape with flying cars and neon lights",negativePrompt:"Grainy, low resolution, poorly drawn buildings",width:512,height:512,numOutputs:1,outputImage:"/assets/mock/general/meshadventures_A_dramatic_view_of_the_Empire_State_Building_fro_8e20eb61-7df8-43b5-80bb-7ad75f47f3f6.png"},{id:4,scheduler:"DDIM",inferenceSteps:50,guidanceScale:10,promptStrength:.95,seed:"67890",prompt:"Photorealistic portrait of a cyberpunk character with neon implants and futuristic background",negativePrompt:"Cartoon, anime, illustration, bad proportions, deformed",width:512,height:512,numOutputs:1,outputImage:"/assets/mock/general/anzhelikos_A_breathtaking_landscape_of_cherry_blossom_trees_in__12357cff-490a-4a39-bb83-cfb4bba207d7.png"}]));return(i,r)=>(d(),p("div",to,[t("div",ao,[(d(!0),p(L,null,J(a.value,l=>(d(),q(eo,{key:l.id,example:l,class:"example-item"},null,8,["example"]))),128))])]))}},so=$(oo,[["__scopeId","data-v-65732978"]]),io={class:"docs-nav-panel"},no={class:"nav-content"},ro={__name:"DocsNavPanel",props:{sections:{type:Array,required:!0},selected:{type:String,required:!0}},emits:["update:selected"],setup(e,{emit:s}){const a=s,i=r=>{a("update:selected",r)};return(r,l)=>(d(),p("div",io,[l[0]||(l[0]=t("div",{class:"panel-header"},[t("div",{class:"panel-title"},"documentation")],-1)),t("div",no,[o(It,{density:"compact","bg-color":"transparent",class:"docs-list"},{default:c(()=>[(d(!0),p(L,null,J(e.sections,n=>(d(),p("div",{key:n.id},[o(xt,{class:"section-title"},{default:c(()=>[f(m(n.title),1)]),_:2},1024),(d(!0),p(L,null,J(n.items,u=>(d(),q(At,{key:u.id,value:u.id,active:e.selected===u.id,onClick:y=>i(u.id),class:be(["nav-item",{active:e.selected===u.id}])},{default:c(()=>[o(St,{class:"item-title"},{default:c(()=>[f(m(u.title),1)]),_:2},1024)]),_:2},1032,["value","active","onClick","class"]))),128))]))),128))]),_:1})])]))}},je=$(ro,[["__scopeId","data-v-f4c4243d"]]),lo={class:"docs-content"},co={class:"content-header"},uo={class:"content-title"},mo={class:"content-body"},po={key:0,class:"paragraph"},go={key:1,class:"image-container"},ho=["src","alt"],fo={key:0,class:"image-caption"},_o={key:2,class:"code-block"},vo={class:"code-language"},yo={class:"code-content"},bo={key:3,class:"content-list"},wo={__name:"DocsContent",props:{doc:{type:Object,required:!0}},setup(e){return(s,a)=>(d(),p("div",lo,[t("div",co,[t("h1",uo,m(e.doc.title),1)]),t("div",mo,[(d(!0),p(L,null,J(e.doc.content,(i,r)=>(d(),p("div",{key:r,class:be(["content-item",i.type])},[i.type==="paragraph"?(d(),p("p",po,m(i.text),1)):i.type==="image"?(d(),p("div",go,[t("img",{src:i.src,alt:i.alt,class:"content-image"},null,8,ho),i.caption?(d(),p("div",fo,m(i.caption),1)):Y("",!0)])):i.type==="code"?(d(),p("div",_o,[t("div",vo,m(i.language),1),t("pre",yo,[t("code",null,m(i.text),1)])])):i.type==="list"?(d(),p("ul",bo,[(d(!0),p(L,null,J(i.items,(l,n)=>(d(),p("li",{key:n,class:"list-item"},m(l),1))),128))])):Y("",!0)],2))),128))])]))}},Ge=$(wo,[["__scopeId","data-v-355af899"]]),Ne=[{id:"getting-started",title:"Getting Started",items:[{id:"introduction",title:"Introduction",content:[{type:"paragraph",text:"Welcome to the image generation documentation. This guide will help you understand how to use our powerful image generation tools to create stunning visuals for your projects."},{type:"paragraph",text:"Our system uses state-of-the-art diffusion models to generate high-quality images from text prompts. By providing detailed descriptions, you can guide the AI to create exactly what you envision."},{type:"image",src:"/assets/mock/general/anzhelikos_A_breathtaking_landscape_of_cherry_blossom_trees_in__12357cff-490a-4a39-bb83-cfb4bba207d7.png",alt:"Example of AI generated image",caption:"An example of an AI-generated landscape with cherry blossom trees"},{type:"paragraph",text:"The quality and style of the generated images depend on several factors, including the prompt, negative prompt, and various settings that we will explore in this documentation."}]},{id:"installation",title:"Installation",content:[{type:"paragraph",text:"To get started with our image generation tools, you need to install the required dependencies and set up your environment."},{type:"code",language:"bash",text:`npm install @ai-tools/image-generator
# or
...
});`}]},{id:"support",title:"Support",content:[{type:"paragraph",text:"If you need help with our API, there are several support channels available:"},{type:"list",items:["Documentation: comprehensive guides and reference","Community Forum: connect with other developers","GitHub Issues: report bugs or request features","Email Support: contact our team directly","Discord Community: real-time chat with our team and community"]},{type:"paragraph",text:"For enterprise customers, we offer dedicated support with guaranteed response times and access to our engineering team."}]}]}],ri=e=>{for(const s of Ae)for(const a of s.items)if(a.id===e)return a;return Ae[0].items[0]},li={class:"api-section"},di={class:"api-container"},ci={__name:"ApiSection",setup(e){const s=w(Ae),a=w("introduction"),i=v(()=>ri(a.value));return(r,l)=>(d(),p("div",li,[t("div",di,[o(je,{class:"nav-panel",sections:s.value,selected:a.value,"onUpdate:selected":l[0]||(l[0]=n=>a.value=n)},null,8,["sections","selected"]),o(Ge,{class:"content-area",doc:i.value},null,8,["doc"])])]))}},ui=$(ci,[["__scopeId","data-v-e6e2e72d"]]),mi={class:"generate-view-wrapper"},pi={class:"nav-slider-container"},gi={class:"content-container"},hi={__name:"GenerateView",setup(e){const s=w("run"),a=v(()=>{switch(s.value){case"run":return Ue;case"examples":return so;case"docs":return Io;case"forums":return Fs;case"history":return ni;case"api":return ui;default:return Ue}});return(i,r)=>(d(),p("div",mi,[t("div",pi,[o(Tt,{modelValue:s.value,"onUpdate:modelValue":r[0]||(r[0]=l=>s.value=l)},null,8,["modelValue"])]),t("div",gi,[o(Pe,{mode:"out-in",duration:100},{default:c(()=>[(d(),q(Pt(a.value),{key:s.value,class:"section-component"}))]),_:1})])]))}},bi=$(hi,[["__scopeId","data-v-261f7551"]]);export{bi as default};
